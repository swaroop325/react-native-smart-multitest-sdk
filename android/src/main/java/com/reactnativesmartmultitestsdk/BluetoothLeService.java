...
public class BluetoothLeService extends Service {
    ...
    public int writeCharacteristic(byte charData[]) {
        ...
        BluetoothGattService service = mBluetoothGatt.getService(UUID.fromString(svrUUIDKey)); 
        BluetoothGattCharacteristic characteristic1 = service.getCharacteristic(UUID.fromString(chrUUIDKey));
